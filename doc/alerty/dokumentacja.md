...
| **Alternatywne przepływy zdarzeń:** | 2a. Walidacja zgłoszenia nie powiodła się:  <br/> 1. W kroku 2. AlertController wykrywa brak userID lub błędne dane.  <br/> 2. System zwraca odpowiedź 400 Bad Request z komunikatem błędu.<br/> 3. Przypadek użycia kończy się, alert nie jest tworzony ani zapisywany.<br/> 1a. Wzbogacenie zgłoszenia (Dane opcjonalne): <br/>1. Przed krokiem 1. Mieszkaniec może dodać tekstowy opis (message) lub lokalizację (location) do obiektu SosReport. Te dane są przekazywane w żądaniu i zapisywane w kroku 3 w obiekcie Alert.                                                                                                                                                                                                                |
...
Diagram interakcji dla Mieszkańca dla przypadku użycia "Zgłoś SOS"
...
| **Alternatywne przepływy zdarzeń:** | 2a. Walidacja danych nie powiodła się (Blok alt na diagramie):<br/>                                                                                                                                                                                                                                                                                                           1. W kroku 2. AlertRuleEngineController wykrywa błąd walidacji (np. brak wymaganej metryki lub błędny format JSON).<br/> 2. System przerywa przetwarzanie (nie wywołuje serwisu ani bazy danych).<br/> 3. System zwraca odpowiedź 400 Bad Request z komunikatem błędu.<br/> 4. Przypadek użycia kończy się niepowodzeniem. |
...
Diagram interakcji dla Inżyniera dla przypadku użycia "Definiuj nową regułę"
...
![img.png](img/img.png)
W głównym panelu![img_6.png](img/img_6.png) kliknij przycisk Alerts.
