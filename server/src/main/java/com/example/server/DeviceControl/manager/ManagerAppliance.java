<<<<<<<< HEAD:server/src/main/java/com/example/server/DeviceControl/manager/ManagerAppliance.java
...
>>>>>>>> origin/DeviceControl-vlad-Adam:server/src/main/java/com/example/server/DeviceControl/ManagerAppliance.java
}